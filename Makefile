...
#    Updated: 2019/03/06 03:22:19 by cdimitro         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC = ft_atoi.c ft_bzero.c ft_isalnum.c ft_isalpha.c ft_isascii.c \
	ft_isdigit.c ft_isprint.c ft_itoa.c  ft_toupper.c ft_tolower.c \
	...
	ft_strsub.c ft_strtrim.c ft_swap.c 
...
OFILES = ft_atoi.o ft_bzero.o ft_isalnum.o ft_isalpha.o ft_isascii.o \
	...
	ft_strstr.o ft_strsub.o ft_strtrim.o ft_swap.o

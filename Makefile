...
#    Updated: 2019/03/05 20:52:52 by cdimitro         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC = ft_atoi.c ft_bzero.c ft_isalnum.c ft_isalpha.c ft_isascii.c \
	ft_isdigit.c ft_isprint.c ft_itoa.c ft_itoa_neg.c ft_itoa_pos.c \
	...
	ft_strsub.c ft_strsub_delim.c ft_strtrim.c ft_swap.c ft_tolower.c \
	ft_toupper.c ft_word_count.c

OFILES = ft_atoi.o ft_bzero.o ft_isalnum.o ft_isalpha.o ft_isascii.o \
	ft_isdigit.o ft_isprint.o ft_itoa.o ft_itoa_neg.o ft_itoa_pos.o \
	...
	ft_strstr.o ft_strsub.o ft_strsub_delim.o ft_strtrim.o ft_swap.o \
